...
NumberedNote nnnn_full_melody[] = {
    ...
    {3, 4, 0, 1, 0, 0},     // 3_ - 中音3，八分音符
    {2, 4, 0, 1, 0, 0},     // 2_ - 中音2，八分音符
    {4, 4, 0, 1, 0, 0},     // 4_ - 中音4，八分音符
    {3, 4, 0, 1, 0, 0},     // 3_ - 中音3，八分音符
    {2, 4, 0, 1, 0, 0},     // 2_ - 中音2，八分音符
    ...
    // 7 1h_ 7 1h_ |
    {7, 4, 0, 0, 0, 0},     // 7 - 中音7，四分音符
    {1, 5, 0, 1, 0, 0},     // 1h_ - 高音1，八分音符
    {7, 4, 0, 0, 0, 0},     // 7 - 中音7，四分音符
    {1, 5, 0, 1, 0, 0},     // 1h_ - 高音1，八分音符
    
    // 7__ 6__ 5 5_ 2_ 4_ |
    {7, 4, 0, 2, 0, 0},     // 7__ - 中音7，十六分音符
    {6, 4, 0, 2, 0, 0},     // 6__ - 中音6，十六分音符
    ...
    // 4 3_ 3 5L_ |
    {4, 4, 0, 0, 0, 0},     // 4 - 中音4，四分音符
    {3, 4, 0, 1, 0, 0},     // 3_ - 中音3，八分音符
    {3, 4, 0, 0, 0, 0},     // 3 - 中音3，四分音符
    {5, 3, 0, 1, 0, 0},     // 5L_ - 低音5，八分音符
